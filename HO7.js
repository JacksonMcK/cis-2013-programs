...
var do_it = function () 
{
	...
	alert ("The Rectangle area is " + floatRectArea(floatRectWidth, floatRectHeight) + 
	" and the perimeter is " + floatRectPerim(floatRectWidth, floatRectHeight) + 
	"\n\n" + "The Triangle area is " + 	floatTriArea(floatTriSide1, floatTriSide2, floatTriSide3) + 
	" and the perimeter is " + 
	floatTriPerim(floatTriSide1, floatTriSide2, floatTriSide3) + "\n\n" +
	"The Circle area is " + floatCircArea(floatRadius) + 
